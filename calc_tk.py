...
# number9 = Button(root, text = "9", ).grid(row = 0, column = 0)
# number8 = Button(root, text = "8", ).grid(row = 0, column = 1)
# number7 = Button(root, text = "7", ).grid(row = 0, column = 2)
# number6 = Button(root, text = "6", ).grid(row = 1, column = 0)
# number5 = Button(root, text = "5", ).grid(row = 1, column = 1)
# number4 = Button(root, text = "4", ).grid(row = 1, column = 2)
# number3 = Button(root, text = "3", ).grid(row = 2, column = 0)
# number2 = Button(root, text = "2", ).grid(row = 2, column = 1)
# number1 = Button(root, text = "1", ).grid(row = 2, column = 2)
# number0 = Button(root, text = "0", ).grid(row = 3, column = 0)
# plus = Button(root, text = "+", ).grid(row =3 , column = 1)
# minus = Button(root, text = "-", ).grid(row = 3, column = 2)
...
def submit_action():
    global submit_name
    label1 = Label(root, text="Data submitted successfully!")
    label1.pack()

    submit_name = Fname_ent.get()
    print(submit_input)

Fname_lab = Label(text = 'Enter your First Name').pack(padx = 0, pady = 10)
Fname_ent = Entry(root, takefocus = False).pack(padx = 15, pady = 20)

Lname_lab = Label(text = 'Enter your First Name').pack(padx = 0, pady = 10)
Lname_ent = Entry(root, takefocus = False).pack(padx = 15, pady = 20)

submit_button = Button(root, text= 'Submit', command = submit_action).pack(padx = 10, pady = 20)
quit_button = Button(root, text= 'Quit', command = quit).pack(padx = 10, pady = 20)
